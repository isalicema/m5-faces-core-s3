...
inline lgfx::VLWfont body, title, tinyFont;
inline bool ready=false;
inline bool begin(){if(ready)return true;ready=tinyFont.loadFont(&tinyData)&&body.loadFont(&bodyData)&&title.loadFont(&titleData);return ready;}
